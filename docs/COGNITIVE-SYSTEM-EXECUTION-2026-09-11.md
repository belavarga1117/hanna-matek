...
Állapotdelta, 2026-09-11 11:45 CEST: a dokumentált `d852e80` jelölt Railway production kiadása `SUCCESS` (`c9514bdf-4147-4429-9693-1630b860fb4f`). A futó forrás 90/90, a publikus állományok 73/73 SHA-egyezést és a health végpont zöld választ adott. A friss production oldalon a hub és a kilencrekordos forrásfiók látható. Két új, kizárólag saját QA-fiókkal az élő térbeli mérés, a szerveresen pontozott aktív felidézés első és későbbi köre, a valódi kép–hely késleltetési kapu, az idempotens beküldés, a friss újrabelépés és a tanári 2/2 részletek végigmentek. A fiókokat utána inaktiváltuk, saját munkameneteiket töröltük, a hitelesítő fájlt megsemmisítettük; az eredeti négy felhasználói rekord változatlan. A teljes sor lezárt, az egyetlen őszintén ellenőrizetlen pont továbbra is a CUA által nem előidézhető valódi böngésző-háttérbe helyezési esemény.
